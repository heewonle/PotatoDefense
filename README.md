...
| 🌽 옥수수 | Projectile | 관통 (최대 2회) | 30발 | 1:2 |
| 🎃 호박 | Grenade | 폭발 범위 데미지 (3m) | 10발 | 1:5 |
| 🥕 당근 | Hitscan | 산탄 8발 확산 (±15°) | 15발 | 1:3 |
...
|---|---|---|---|
| 🌾 밭 | 나무 50, 농작물 25 | 농작물 생산+ | — |
| 🐄 축사 | 나무 50, 농작물 25 | 동물 배치로 생산+ | 최대 5마리 |
| 🪓 벌목장 | 나무 50, 농작물 50 | NPC 배치 가능 | 벌목꾼 배치 시 생산 증가 |
| ⛏️ 광산 | 나무 50, 광석 100 | NPC 배치 가능 | 광부 배치 시 생산 증가 |
